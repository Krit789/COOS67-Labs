...
> [!IMPORTANT] > **ไม่ได้ `COPY . .`** เพราะจะใช้ **Bind Mount** แทน เพื่อ mount โฟลเดอร์ source code จากเครื่อง host เข้า container **ทำให้แก้ไข code แล้ว container เห็นผลทันที (hot-reloading)**
